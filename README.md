...
- 双击运行进入小程序界面
![](https://github.com/uboger/LRC-to-premiere-subtitles/blob/master/OU_2)PMCTX)D)HATWEQ8T7T.png "小程序界面")
...
![](https://github.com/uboger/LRC-to-premiere-subtitles/blob/master/T%5DG~59U~_9LF)L6E(8%24SV%25P.png"点击另存为")
